        ...
        <SidebarMenuItem>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                <div className="bg-muted dark:bg-muted-foreground text-sidebar-primary-foreground flex aspect-square size-8 items-center justify-center rounded-lg overflow-hidden">
                  {activeOrg?.logo_url ? (
                    <img
