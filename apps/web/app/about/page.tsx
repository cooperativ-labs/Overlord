...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      <h1 className="text-3xl font-bold tracking-tight">About Overlord</h1>
      <p className="mt-2 text-sm text-muted-foreground">
        A hobby project by <Link href="https://jacobchaselubitz.com&utm_source=overlord" className="text-primary underline underline-offset-4">Jacob Chase-Lubitz</Link>
      </p>

      <div className="mt-8 space-y-8 text-sm leading-7 text-foreground">
        <section className="space-y-3">
          <h2 className="text-lg font-semibold">What Overlord is</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold">About Jacob</h2>
          <p>
