...
6. If the user wants to find a ticket but does not know the ID, run `ovld protocol search-tickets --query "..." --status next-up,execute` and ask the user to confirm. For interactive ticket search and agent launch, prefer `ovld attach`.
