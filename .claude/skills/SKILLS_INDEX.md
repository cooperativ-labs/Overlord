...
- **Description:** Current Overlord terminal and connector patterns for Electron, web MCP clients, cloud agents, and the human CLI.
- **File:** agent-terminal-connectors/SKILL.md
