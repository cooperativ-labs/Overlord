    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          ...
          backend. Switching restarts the app so the profile you pick starts clean, and requires
          signing in again for that backend. The CLI backend URL in{' '}
          <code className="text-xs">~/.ovld/overlord.toml</code> updates with this switch, but CLI
          auth does not — run <code className="text-xs">ovld auth status</code> after changing
          backends.
        </p>
      </div>
