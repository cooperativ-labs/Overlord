...
5. Follow-up messages after the initial ticket are captured automatically by the installed {{hookDescription}}. Do not post `user_follow_up` manually unless the hook is unavailable.
