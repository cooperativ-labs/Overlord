...
| Command                                                                                                                                                                               | What it does                                                                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ovld create "<objective>" [--objectives-json <json>] [--title <text>] [--project-id <id>] [--resource <key>] [--auto-advance\|--no-auto-advance] [--json]`                           | Create a draft mission.                                                                                                                                                                   |
| `ovld inbox create --title <text> --objective <text> [--json]`                                                                                                                        | Create a private, account-owned unassigned task capture.                                                                                                                                 |
| `ovld prompt "<objective>" [--objectives-json <json>] [--title <text>] [--project-id <id>] [--resource <key>] [--agent <id>] [--auto-advance\|--no-auto-advance] [--json]`            | Create a mission and queue execution.                                                                                                                                                    |
...
| `ovld inputs send --channel-id <id> --body <text> [--kind <kind>] [--json]`                                | Send an instruction to one live session channel.                                                                                |
